 ...
 *  @author Kevin Wayne
 *
 * This file was modified for CISC 380
 * the method findPath(int x, int y) was added and should be implemented.
 *
 */
public class PrimMST {
	...
	/**
	* 
	* prints to the screen the unique path between two vertices x and y in the current MST.
	* runs in O(n), where n is the number of vertices.
	*
	*@param x the number of the first vertex.
	*@param y the number of the second vertex.
	*	
	*/
